...
construct 
double : nat -> nat,
double-eq : (n : nat) -> eq nat nat (double n) (plus n n)
by 
given M : type, 
given portal : (double : nat -> nat) -> (double-eq : (n : nat) -> eq nat nat (double n) (plus n n)) -> M,
portal @ (abs-ap nat nat nat plus (abs-id nat)) (
    given n : nat,
    ?
)